  ...
  return (
    <footer className="bg-white text-black text-center">
      <div className="container flex flex-wrap justify-between border-b-2 py-12">
        <div className="flex mb-8 flex-wrap w-[100%] sm:w-[30%] flex-col gap-2 ">
          ...
          <p>YumYum@kinbo.com</p>
        </div>
        <div className="flex w-[30%] flex-col gap-2 text-black">
          <p>Quick Links</p>
          <HashLink
            smooth
            to="/#hero"
      ...
      <div className="container flex flex-col items-center justify-between gap-2 py-6 text-black md:flex-row">
        <p className="opacity-30 duration-1000 hover:opacity-100">
          YumYum eFood © {new Date().getFullYear()}. All Rights Reserved
        </p>
